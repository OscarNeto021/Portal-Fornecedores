...
const userId = localStorage.getItem('CD_FORN');
const userIdInt = parseInt(userId, 10);

if (isNaN(userIdInt)) {
  console.log('O valor em localStorage não é um número válido.');
} else {
  console.log('Valor convertido:', userIdInt);
}
console.log("Token recuperado do localStorage2:", userIdInt)
